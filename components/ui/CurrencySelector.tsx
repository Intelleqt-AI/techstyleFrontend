...
export const CurrencySelector = ({ value, onChange, data }) => {
  ...
  const selectedCurrency = currencies.find(c => c.value === currentValue.value);
  return (
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className=" h-auto font-medium text-[#17181B] border outline-none rounded-xl py-2 px-4 w-full flex text-sm justify-between bg-white hover:bg-white"
          >
            {selectedCurrency ? (
