...
export function PricingStep({ data, onUpdate }: PricingStepProps) {
  const [lineItems, setLineItems] = useState<LineItem[]>(data.lineItems || [{ id: '1', description: '', quantity: 1, rate: 0, amount: 0 }]);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" size="sm" onClick={addLineItem} className="gap-2 bg-white border-borderSoft hover:bg-greige-50">
              ...
              <table className="w-full">
                <thead className="bg-greige-50 border-b border-borderSoft">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center text-sm font-medium text-ink-muted" style={{ width: '5%' }}></th>
                  </tr>
                </thead>
