...
const MemberProjectBreakdown = ({ trackingData, trackingLoading, user, month }) => {
  ...
  return (
    <ChartCard title="Tracking Breakdown" description="Breakdown of current month">
      {/* Header */}
      {/* <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <button className="flex items-center justify-between px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-w-[120px]">
