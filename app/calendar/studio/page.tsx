                    ...
                    return (
                      ...
                      >
                        <div className={`text-xs font-medium ${isCurrent ? "text-[#A14A35]" : "text-gray-600"}`}>
                          {type === "day"
                            ? new Date(period.date).toLocaleDateString("en-US", { weekday: "short" })
                            : ""}
                        </div>
                        <div className={`text-xs ${isCurrent ? "text-[#CE6B4E] font-semibold" : "text-gray-500"}`}>
                          {period.label}
                        </div>
                      </div>
                    )
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1 bg-white border border-gray-200 rounded-lg p-1">
              <Button
                ...
                size="sm"
                className={`h-8 px-3 text-sm font-medium ${
                  activeView === "month" ? "bg-gray-100 text-gray-900" : "text-gray-600"
                }`}
              ...
              <Button
                ...
                size="sm"
                className={`h-8 px-3 text-sm font-medium ${
                  activeView === "week" ? "bg-gray-100 text-gray-900" : "text-gray-600"
                }`}
              ...
              <Button
                ...
                size="sm"
                className={`h-8 px-3 text-sm font-medium ${
                  activeView === "today" ? "bg-gray-100 text-gray-900" : "text-gray-600"
                }`}
