            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-neutral-600">
                    {selectedProject?.currency?.symbol || "£"}0 projected
                  </p>
          ...
          <CardContent className="p-6">
            ...
            <div className="relative">
              {selectedProject?.phases?.length && (
                <div
                  className={`grid items-center justify-center gap-5 grid-cols-${selectedProject?.phases?.length}`}>
                      ...
                      <div
                        ...
                        <div>
                          <Slider
                            ...
                            onValueChange={([val]) =>
                              updatePhase(index, { progress: val })
                            }></Slider>
                          ...
                          <div className="mt-2 text-center">
                            <div
                              className={`text-xs font-medium ${
                                isCurrent ? "text-clay-600" : "text-neutral-700"
                              }`}>
                              {phase.name}
                            </div>
                            ...
                            <div
                              className={`text-xs ${
                                isCurrent ? "text-clay-800" : "text-neutral-500"
                              }`}>
                              {start
        ...
        <Card className="border border-greige-500/30 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                onClick={() =>
                  router.push(`/projects/${selectedProject?.id}/procurement`)
                }
                variant="outline"
                size="sm"
