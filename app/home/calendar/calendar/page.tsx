                        ...
                        {eventData && (
                          <div className="space-y-1">
                            {eventData.events.map((event, idx) => (
                              <div key={idx} className={`w-full h-1.5 rounded-full ${event.color} ring-1 ring-gray-200`} />
                            ))}
                          </div>
                        )}
                      </>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-8 gap-1 mb-4">
              ...
              {weekEvents.map(day => (
                <div key={day.day} className="p-3 text-center">
                  ...
                  <div className={`text-lg font-semibold mt-1 ${day.date === 6 ? 'text-[#CE6B4E]' : 'text-gray-900'}`}>{day.date}</div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-1">
              {Array.from({ length: 12 }, (_, i) => {
                ...
                return (
                  <div key={hour} className="grid grid-cols-8 gap-1 min-h-[60px] border-b border-gray-100 last:border-b-0">
                    ...
                    {weekEvents.map(day => {
                      ...
                      return (
                        <div key={`${day.day}-${hour}`} className="p-1 border-r border-gray-100 last:border-r-0 relative">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
        <div className="p-6">
          ...
          <div className="space-y-4">
            {todayEvents.map(event => (
              <div key={event.id} className="flex items-start gap-6 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      className={`w-4 h-4 rounded-full ${event.color.split(' ')[0]} ring-2 ${event.color
                        .split(' ')[1]
                        .replace('border-', 'ring-')}`}
                    />
